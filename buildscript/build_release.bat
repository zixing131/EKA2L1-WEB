@echo off
REM ============================================================================
REM EKA2L1-WEB Release build -- Windows port of build_release.sh.
REM
REM Output: build_wasm_release\  (full protection)
REM EKA2L1_DEBUG_BUILD is OFF: copyright notice, file-integrity checks, domain
REM whitelist and the version watermark are all active. The POST_BUILD step
REM (gen_integrity.py) seals the asset hashes into eka2l1.wasm and writes
REM js/integrity.js.
REM
REM Usage:
REM   Double-click build_release.bat        configure + build
REM   set JOBS=8 ^& build_release.bat       override parallelism (default 4)
REM
...
set "BUILD_DIR=%ROOT%\build_wasm_release"
