...
foreach(page ${STAMP_PAGES})
    ...
    string(REPLACE "src=\"js/i18n.js\"" "src=\"js/i18n.js?v=${BUILD_ID}\"" content "${content}")
    string(REPLACE "src=\"js/i18n/zh-CN.js\"" "src=\"js/i18n/zh-CN.js?v=${BUILD_ID}\"" content "${content}")
