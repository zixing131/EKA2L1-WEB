...
(function () {
    ...
    EKA2L1.keys = {
        ...
        // S60's hardware menu key is EStdKeyApplication0 (0xb4).  0x94 is
        // EStdKeyMenu, a different legacy key that the 5320 does not capture.
        MENU: 0xb4, CALL: 0xc4, END: 0xc5, CLEAR: 0x01,
        STAR: 0x85, HASH: 0x7f,
