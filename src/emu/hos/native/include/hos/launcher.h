...
namespace eka2l1::hos {
    // HarmonyOS launcher. Functionally a copy of eka2l1::android::launcher, with
    // app-icon decoding returning a portable icon_bitmap and the UI dialogs routed
    // through ui_callbacks instead of JNI.
    class launcher {
        eka2l1::system *sys;
        config::state *conf;
